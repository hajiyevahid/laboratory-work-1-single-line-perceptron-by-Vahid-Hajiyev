    ...
    class Program
    {
        ...
        float[] calcualteOutput(float[] weights, float bias)
        {
            ...
            if (error[0] != 0)
            {
                ...
                //  float[] updateSet = { weights[0], apple1[0], weights[1], apple1[1], error[0], bias };
            ...
            else if (error[1] != 0)
            {
                ...
                //  float[] updateSet = { weights[0], apple2[0], weights[1], apple2[1], error[1], bias };
            ...
            else if (error[2] != 0)
            {
                ...
                //float[] updateSet = { weights[0], apple3[0], weights[1], apple3[1], error[2], bias };
            ...
            else if (error[3] != 0)
            {
                ...
                // float[] updateSet = { weights[0], apple4[0], weights[1], apple4[1], error[3], bias };
            ...
            else if (error[4] != 0)
            {
                ...
                //float[] updateSet = { weights[0], apple5[0], weights[1], apple5[1], error[4], bias };
            ...
            else if (error[5] != 0)
            {
                ...
                // float[] updateSet = { weights[0], pear1[0], weights[1], pear1[1], error[5], bias };
            ...
            else if (error[6] != 0)
            {
                ...
                //float[] updateSet = { weights[0], pear2[0], weights[1], pear2[1], error[6], bias };
            ...
            else if (error[7] != 0)
            {
                ...
                // float[] updateSet = { weights[0], pear3[0], weights[1], pear3[1], error[7], bias };
        ...
        static void Main(string[] args)
        {
            ...
            //------------------------------------------------------------------------------------------------------------------          
            //deyisenden soa updatesetin adin deyis
